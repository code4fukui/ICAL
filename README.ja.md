...
ターミナルから以下のコマンドを実行し、CSVファイルからiCalendarファイルを生成できます。

```sh
deno run -A https://code4fukui.github.io/ICAL/csv2ical.js [ファイル名].csv
```

### ライブラリ

JavaScriptのコードから以下のように使用できます。
